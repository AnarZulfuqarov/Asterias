                        ...
                        <div className={"text"}>
                           <div className={"head"}>
                               <h2 style={{ fontSize: i18n.language === 'az' ? '48px' : i18n.language === 'en' ? '36px' : '34px' }}>
                                   <img src={icon} alt="icon"/> {t('servDetailOne.header')}
                               </h2>
                            ...
                            <div className={"functions"}>
                                <div className={"function1"} style={{ width: i18n.language === 'az' ? '224px' : i18n.language === 'en' ? '224px' : '300px' }}>
                                    ...
                                    <div className={"content"} >
                                        ...
                                        <span>{t('servDetailOne.functions.duration_value')}</span>
                                    </div>
                                </div>
                                <div className={"function2"}>
                                    ...
                                    <div className={"content"}><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        ...
                                        <span>{t('servDetailOne.functions.age_value')}</span></div>

                                </div>
                            </div>
                            <button onClick={()=>navigate("/contact")}>{t('servDetailOne.button')}</button>
